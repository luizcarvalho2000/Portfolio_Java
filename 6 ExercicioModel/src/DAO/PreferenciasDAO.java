...
public class PreferenciasDAO {
	...
	public DefaultListModel<String> BancoConectado() throws Exception {
        ...
        try {
            ...
            while(rsPreferencias.next()) {
                PreferenciasVO objPreferenciasVO = new PreferenciasVO();
                objPreferenciasVO.setDescricao(rsPreferencias.getString("Descricao"));
                
                modelo.addElement(objPreferenciasVO.getDescricao());
            }
            ...
            if (con != null) {
            	try {
            		DB_DAO.getInstancia().fecharConexao();
            	}catch (Exception ex) {
                	throw ex;
                }            	
            }
	...
	public Boolean InserirBD(PreferenciasVO preferencias) throws Exception {
		...
		try {
            ...
            psql.setString(1, preferencias.getDescricao());
	...
	public Boolean DeletarBD(PreferenciasVO preferencia) throws Exception {
		Connection con = DB_DAO.getInstancia().getConexao();
		try {
            StringBuilder strSql = new StringBuilder();
